...
if (!sessionStorage.getItem('campsbayComments')) {
  ...
  sessionStorage.setItem('campsbayComments', JSON.stringify(seedComments));
}


// Check if there are any comments stored in session storage
if (sessionStorage.getItem('campsbayComments')) {
  const comments = JSON.parse(sessionStorage.getItem('campsbayComments'));
...
document.getElementById('commentForm').addEventListener('submit', function(event) {
  ...
  const comments = sessionStorage.getItem('campsbayComments')
    ? JSON.parse(sessionStorage.getItem('campsbayComments'))
    : [];
  ...
  sessionStorage.setItem('campsbayComments', JSON.stringify(comments));
